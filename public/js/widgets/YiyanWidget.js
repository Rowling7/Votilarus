...
import YiyanFavoritesModal from '../modal/YiyanFavoritesModal.js';
...
class YiyanWidget extends BaseWidget {
                ...
                <div class="yiyan-header">
                    <button class="yiyan-source-btn" title="切换数据源">
                        ${this.getSourceName()}
                                        ...
                                        <div class="yiyan-header-right">
                        <button class="yiyan-favorites-list-btn" title="查看收藏">
  ...
  <path d="M2 15.5a.5.5 0 0 0 .74.439L8 13.069l5.26 2.87A.5.5 0 0 0 14 15.5V2a2 2 0 0 0-2-2H4a2 2 0 0 0-2 2zM8 4.41c1.387-1.425 4.854 1.07 0 4.277C3.146 5.48 6.613 2.986 8 4.412z"/>
    ...
    bindEvents() {
        ...
        // 查看收藏列表按钮
        const favoritesListBtn = this.container.querySelector('.yiyan-favorites-list-btn');
        if (favoritesListBtn) {
            favoritesListBtn.addEventListener('click', (e) => {
                e.stopPropagation();
                YiyanFavoritesModal.open();
            });
        }
